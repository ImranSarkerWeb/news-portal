...
const displayCategory = (data) => {
    data.news_category.forEach(element => {
      url = `https://openapi.programming-hero.com/api/news/category/${element.category_id}`
     linkContainer.innerHTML += ` <li> <a class="text-decoration-none text-black" href="#" onclick="getData('${url}', displayNews)">${element.category_name} </a></li>`
    });
